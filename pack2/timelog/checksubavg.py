...
cwd = "/home/chaztikov/Documents/data/pack2/timelog/TCATtimelog/"
...
errors = []
#f=open("errors.csv","w+")
header = " ".join(['pw', 'pn', 'awn', 'ans', 'aws', 'Jwn', 'Kwn', 'lwns',
...
#    total /= swvfs_total
    ...
    print(error[inz] / total0[inz],
          len(inz))
    errors.append(error.values[3:])

if(use_weighted_average):
    np.savetxt("errors_porosweighted.csv",errors,header=header)
else:
    np.savetxt("errors.csv",errors,header=header)
